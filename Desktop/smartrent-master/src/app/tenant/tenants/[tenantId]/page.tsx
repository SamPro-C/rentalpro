...
export default function TenantProfilePage() {
  ...
  const handleEditInfo = () => {
    ...
    router.push(`/landlord/tenants/edit/${tenant.id}`); 
  };
  ...
  const handleViewLease = () => {
    toast({title: "View Lease Agreement", description: "Displaying lease agreement. This feature is not fully interactive yet."})
  }
